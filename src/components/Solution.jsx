...
const solutions = [
  {
    ...
    detail: 'Customers, orders, quotes and communications — all centralized. Instant access from any device, anytime.',
  ...
  },
  {
    ...
    solution: 'Professional quotes in just a few clicks',
    detail: 'Generate custom quotes with up-to-date pricing. Send them to clients in a professional PDF format directly from the CRM.',
