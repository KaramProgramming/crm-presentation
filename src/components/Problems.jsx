...
const problems = [
  {
    ...
    desc: "Quotes on Excel, customers on paper, orders over WhatsApp. No unified view of your business.",
  },
  {
    icon: PhoneMissed,
  ...
  },
  {
    ...
    desc: 'Your team spends hours copying data, recreating quotes, and searching for information about existing customers.',
  },
  {
    icon: BarChart2,
  ...
  },
  {
    ...
    desc: "Every salesperson works their own way. There's no shared workflow from quote to delivery.",
  },
]
