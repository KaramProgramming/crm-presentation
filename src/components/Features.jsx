...
const features = [
  {
    ...
    desc: 'Full customer profiles with purchase history, style preferences, sent quotes, sales notes and contacts — all in one unified view.',
    bullets: ['360° customer profile', 'Quote & order history', 'Advanced tagging & segmentation', 'Communication log'],
  },
  {
    id: 'sales',
    icon: TrendingUp,
    ...
    desc: 'Visualize every deal in an intuitive kanban board. Move leads through the stages: Interest → Quote → Negotiation → Closed.',
  ...
  },
  {
    ...
    tagline: 'Professional, fast, error-free',
    desc: 'Create quotes with configurable pricing per customer type, margins, discounts and notes. Export to branded PDF in seconds.',
    bullets: ['Multiple price lists per client', 'Configurable discounts & margins', 'Branded PDF export', 'Digital acceptance'],
  },
  {
    id: 'dashboard',
  ...
  },
  {
    ...
    desc: 'Manage your entire furniture catalog with variants, materials, dimensions and prices — directly linked to quotes.',
  ...
  },
  {
    ...
    desc: 'The system reminds your team when to call a customer back, when a quote is about to expire, or when an order needs attention.',
    bullets: ['Automatic reminders', 'Quote expiry alerts', 'Delayed order warnings', 'Weekly digest for managers'],
  },
]
